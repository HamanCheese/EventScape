...
namespace EventScape.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> ComingSoon(string searchString, DateTime searchDate)
        {

            ViewData["CurrentFilter"] = searchString;
            ViewData["DateFilter"] = searchDate;
            var Events = from s in _context.Events
                         select s;
            var EventsDate = from e in _context.Events
                             select e;
            ...
            if (Events != null)
            {
                ...
                //Events = Events.Where(s => s.Location.Contains(searchString));
                // EventsDate = Events.Where(e => e.ShowStartDate==searchDate);
                //if (!String.IsNullOrEmpty(searchString) || searchDate != null) 
                //{
                //    if (!String.IsNullOrEmpty(searchString) && searchDate != null)
                //    {
                //        Events = Events.Where(s => s.Location.Contains(searchString) && s.ShowStartDate == searchDate);
        ...
        public async Task<IActionResult> UpcomingEvents(string searchString, DateTime searchDate)
        {
        ...
        public async Task<IActionResult> Happening(string searchString, DateTime searchDate)
        {
